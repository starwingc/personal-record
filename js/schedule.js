...
export const STRENGTH_EXERCISES = [
  ...
  { name: '哑铃划船(左右各)', sets: '3组 x 12-15次', desc: '一手一膝撑于椅面,另一手持哑铃向腰侧拉起' },
  { name: '哑铃弯举', sets: '3组 x 12-15次', desc: '双手持哑铃,手肘固定于体侧,屈臂向上弯举' },
  { name: '哑铃俯身臂屈伸', sets: '3组 x 12-15次', desc: '上身前倾,手肘固定于体侧,向后伸直手臂' },
